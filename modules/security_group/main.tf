...
#3 Create Docker_host Security Group
...
#4 Create Jenkins Security Group
...
#5 Create Ansible Security Group
...
#6 Create Docker_lb Security Group
...
#7 Create Jenkins_lb Security Group
